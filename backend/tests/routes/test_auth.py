...
async def test_signup_success(mock_user_crud, app):
    ...
    mock_user_crud.create_user = AsyncMock(return_value={
...
async def test_signup_email_already_exists(mock_user_crud, app):
    ...
    mock_user_crud.get_user_by_email = AsyncMock(return_value={"email": "existing@example.com"})
...
async def test_signup_username_already_exists(mock_user_crud, app):
    ...
    mock_user_crud.get_user_by_email = AsyncMock(return_value=None)
    mock_user_crud.get_user_by_username = AsyncMock(return_value={"username": "existinguser"})
...
async def test_login_success(mock_user_crud, mock_security, app):
    ...
    mock_user_crud.authenticate_user = AsyncMock(return_value={
        "id": "user-id",
        "username": "testuser",
    })
...
async def test_google_login_existing_user(mock_settings, mock_id_token, mock_user_crud, mock_security, app):
    # GIVEN valid Google token and user exists
    mock_settings.GOOGLE_CLIENT_ID = "test-client-id"
    mock_id_token.verify_oauth2_token = MagicMock(return_value={
        "email": "google@example.com",
        "picture": "https://example.com/pic.jpg"
    })
    mock_user_crud.get_user_by_email = AsyncMock(return_value={
        "id": "existing-user-id",
        "email": "google@example.com",
    })
...
@patch("app.routes.auth.id_token")
@patch("app.routes.auth.settings")
async def test_google_login_new_user(mock_settings, mock_id_token, mock_user_crud, mock_security, app):
    ...
    mock_user_crud.get_user_by_email = AsyncMock(return_value=None)
    mock_user_crud.get_user_by_username = AsyncMock(return_value=None)
    mock_user_crud.create_social_user = AsyncMock(return_value={
...
async def test_google_login_invalid_token(mock_settings, mock_id_token, app):
    ...
    mock_settings.GOOGLE_CLIENT_ID = "test-client-id"
    mock_id_token.verify_oauth2_token = MagicMock(side_effect=ValueError("Invalid token"))
