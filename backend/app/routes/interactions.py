...
from app.schemas.interaction import Interaction, InteractionStatus
...
async def toggle_like_article(
    ...
    interaction, like_increment = await interaction_crud.toggle_like(current_user["id"], article_id)
