  ...
  <div class="bg-black min-h-screen pb-20">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
              ...
              >
                  <!-- Background Image -->
                  <img :src="topic.image" :alt="topic.name" class="absolute inset-0 w-full h-full object-cover transition-transform duration-700 group-hover:scale-110" />
                  ...
                  <div class="absolute inset-0 flex flex-col items-center justify-center p-4 text-center">
                      ...
                      <button 
                        ...
                        :class="topic.isFollowed ? 'bg-white text-black' : 'bg-flipboard-red text-white opacity-0 translate-y-4 group-hover:opacity-100 group-hover:translate-y-0'"
                      >
