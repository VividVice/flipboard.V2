...
<template>
  <div class="mt-6">
    ...
    <div v-if="loading && comments.length === 0" class="text-center py-8">
      <div class="inline-block animate-spin rounded-full h-8 w-8 border-b-2 border-flipboard-red"></div>
      <p class="mt-2 text-sm text-gray-400">Loading comments...</p>
    </div>
    ...
    <div v-else-if="comments.length === 0" class="text-center py-8">
      ...
      <p class="text-gray-500 text-xs mt-1">Be the first to share your thoughts!</p>
    </div>
